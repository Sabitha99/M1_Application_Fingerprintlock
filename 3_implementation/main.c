...
void setup() 
{
    ...
    lcd.printf("    MANMOHAN ");
   lcd.setCursor(0,1);
   lcd.printf("POLYTECHNIC COLLAGE");
    ...
    Serial.begin(9600);
    lcd.clear();
    lcd.printf(" Finding Module ");
    lcd.setCursor(0,1);
    delay(2000);
    if (finger.verifyPassword()) 
    {
      Serial.printf("Found fingerprint sensor!");
      lcd.clear();
      lcd.printf(" Module Found  ");
      delay(2000);
    } 
    else
    {
    Serial.printf("Did not find fingerprint sensor :(");
    lcd.clear();
    lcd.printf("Module Not Found");
    lcd.setCursor(0,1);
...
void loop() 
{
  lcd.setCursor(0,0);
    lcd.printf("HUMI    =");
   lcd.printf(DHT.humidity);
   lcd.printf("%  ");
   lcd.setCursor(0,1);
   lcd.printf("TEMP    =");
    lcd.printf(   DHT.temperature); 
   lcd.printf("'C  ");
   delay(5000);
   lcd.clear();
 lcd.setCursor(0,0);
...
uint8_t getFingerprintEnroll() 
{
  ...
  while (p != FINGERPRINT_OK)
  {
    ...
    case FINGERPRINT_NOFINGER:
      ...
      lcd.clear();
      lcd.printf("No Finger");
      break;
    case FINGERPRINT_PACKETRECIEVEERR:
      Serial.printf("Communication error");
      lcd.clear();
      lcd.printf("Comm Error");
      break;
    case FINGERPRINT_IMAGEFAIL:
      Serial.printf("Imaging error");
      lcd.clear();
  ...
  switch (p) {
    case FINGERPRINT_OK:
      Serial.printf("Image converted");
      lcd.clear();
      lcd.printf("Image converted");
      break;
    case FINGERPRINT_IMAGEMESS:
      Serial.printf("Image too messy");
       lcd.clear();
    ...
    case FINGERPRINT_FEATUREFAIL:
      Serial.printf("Could not find fingerprint features");
      lcd.clear();
      lcd.printf("Feature Not Found");
      return p;
...
digitalWrite(buzz, LOW);
lcd.setCursor(2,0);
lcd.printf("WANT ME TO");
lcd.setCursor(1,1);
lcd.printf("REDICULE MORE??");
delay(2500);
lcd.clear();
lcd.setCursor(2,0);
lcd.printf("Ha Ha Ha Ha");
delay(1700);
lcd.clear();
}
